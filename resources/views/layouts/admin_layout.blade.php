...
{{--            <!-- Message Start -->--}}
{{--            <div class="media">--}}
{{--              <img src="/avatars/default-avatar.jpg" alt="User Avatar" class="img-size-50 mr-3 img-circle">--}}
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          <img src="/avatars/default-avatar.jpg" class="img-circle elevation-2" alt="User Image">
        </div>
        <div class="info">
...
<script type="text/javascript">
    tinymce.init({
        selector: ".editor",
        language : 'ru',
        plugins: 'advlist autolink lists charmap print preview hr anchor pagebreak image link media searchreplace wordcount visualblocks visualchars insertdatetime table contextmenu directionality emoticons paste textcolor responsivefilemanager code',
    ...
    function elFinderBrowser (callback, value, meta) {
        tinymce.activeEditor.windowManager.openUrl({
            title: 'File Manager',
            url: '/elFinder-2.1.59/elfinder.html',
            /**
